import{_ as p,r as o,o as c,c as i,a as n,b as s,d as e,e as t}from"./app-55909009.js";const l={},u=t(`<h1 id="cuda入门" tabindex="-1"><a class="header-anchor" href="#cuda入门" aria-hidden="true">#</a> CUDA入门</h1><h2 id="加速系统" tabindex="-1"><a class="header-anchor" href="#加速系统" aria-hidden="true">#</a> 加速系统</h2><p><em>加速系统又称异构系统，由 CPU 和 GPU 组成。加速系统会运行 CPU 程序，这些程序也会转而启动将受益于 GPU 大规模并行计算能力的函数。本实验环境是一个包含 NVIDIA GPU 的加速系统。可以使用</em> <code>*nvidia-smi*</code> <em>(Systems Management Interface</em>) 命令行命令查询有关此 GPU 的信息。现在，可以在下方的代码执行单元上使用 <code>CTRL</code> + <code>ENTER</code> 发出 <code>nvidia-smi</code> 命令。无论您何时需要执行代码，均可在整个实验中找到这些单元。代码运行后，运行该命令的输出将打印在代码执行单元的正下方。在运行下方的代码执行块后，请注意在输出中找到并记录 GPU 的名称。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token operator">!</span>nvidia-smi
